...
![image](2018-06-01T17-22-57_❖ 一篇文章搞定百度OCR图片文字识别API_files/img_01.png)

填好以后点击Send发送，就会获得一个JSON数据，如下图：
![image](2018-06-01T17-22-57_❖ 一篇文章搞定百度OCR图片文字识别API_files/img_02.png)
...
Body的数据如图所示：
![image](2018-06-01T17-22-57_❖ 一篇文章搞定百度OCR图片文字识别API_files/img_03.png)


然后就可以点Send发送请求了。
成功后，可以得到百度云返回的一个JSON数据，类似下图：
![image](2018-06-01T17-22-57_❖ 一篇文章搞定百度OCR图片文字识别API_files/img_04.png)
...
> ![image](2018-06-01T17-22-57_❖ 一篇文章搞定百度OCR图片文字识别API_files/img_05.png)
