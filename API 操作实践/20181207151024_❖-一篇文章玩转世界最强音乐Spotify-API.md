...
![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_01.png)

登录后点击`create a client id`，生成一个专用的`client_id`和`client_secret`。


![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_02.png)


同时必须认真设置`Redirect URIs`，因为日后授权验证时要完全匹配才行。
![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_03.png)
...
![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_04.png)
...
![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_05.png)
...
![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_06.png)

![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_07.png)

完成后，每个页面的Header或URL中，都会自动增加一个`access_token`值。

![image](20181207151024_❖-一篇文章玩转世界最强音乐Spotify-API_files/img_08.png)
