...
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_01.png)
...
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_02.png)
...
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_03.png)
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_04.png)
...
```
JSON填写如下图：
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_05.png)
...
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_06.png)

最后发现原来是犯了很小很小都错误才导致如此：
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_07.png)
原来，我的token看似是正常的，唯独错误的是，多了一个空行！也就是说，标明都是invalid JSON，结果没注意竟然是invalid Token!

增加文件成功后返回的消息：
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_08.png)
...
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_09.png)

或者如果用错了SHA，会出现409错误消息：
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_10.png)

如果正确传送，就会显示200完成更新：
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_11.png)
...
删除成功后，会返回200消息：
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_12.png)
...
### 锁住某条issue 
不允许别人评论（自己可以）
![image](20180205095525_❖-一篇文章搞定Github-API-调用-v3）_img_13.png)
