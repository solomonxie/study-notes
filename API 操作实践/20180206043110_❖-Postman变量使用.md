...
![image](20180206043110_❖-Postman变量使用_files/img_01.png)

引用方法：在各种需要填写信息的地方直接写`{{变量名}}`引用它的值。一般打`{{`就会自动弹出可以选择的变量名。
![image](20180206043110_❖-Postman变量使用_files/img_02.png)
...
![image](20180206043110_❖-Postman变量使用_files/img_03.png)
