...
![image](2018-02-07T06-27-36_❖ 阿里云Code (Git托管）的初始设置_files/img_01.png)

repo页面里面，一不小心漏过了一条提示：
![image](2018-02-07T06-27-36_❖ 阿里云Code (Git托管）的初始设置_files/img_02.png)

按照提示，在Profile->sshkeys页面里面，把本地电脑里`~/.ssh/id_rsa.pub`这个公钥文件内容粘贴到里面，添加密钥：
![image](2018-02-07T06-27-36_❖ 阿里云Code (Git托管）的初始设置_files/img_03.png)

阿里云还需要设置每个参与人员的权限。在控制台里可以找到，如下图：
![image](2018-02-07T06-27-36_❖ 阿里云Code (Git托管）的初始设置_files/img_04.png)
