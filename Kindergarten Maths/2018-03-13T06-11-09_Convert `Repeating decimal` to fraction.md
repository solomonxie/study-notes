...
![image](2018-03-13T06-11-09_Convert `Repeating decimal` to fraction_files/img_01.png)
...
![image](2018-03-13T06-11-09_Convert `Repeating decimal` to fraction_files/img_02.png)

or this,

![image](2018-03-13T06-11-09_Convert `Repeating decimal` to fraction_files/img_03.png)

or even this,

![image](2018-03-13T06-11-09_Convert `Repeating decimal` to fraction_files/img_04.png)


Here're some examples to convert repeating decimals to fraction:
- For simple repeating: set the number as x, then for example:
![image](2018-03-13T06-11-09_Convert `Repeating decimal` to fraction_files/img_05.png)

- For more decimals repeating:

![image](2018-03-13T06-11-09_Convert `Repeating decimal` to fraction_files/img_06.png)
