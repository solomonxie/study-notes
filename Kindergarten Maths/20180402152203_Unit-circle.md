...
`30-60-90 Triangle`:
![image](20180402152203_Unit-circle_files/img_01.png)

`45-45-90 Triangle`:
![image](20180402152203_Unit-circle_files/img_02.png)

`Unit Circle with Special Right Triangles`:
![image](20180402152203_Unit-circle_files/img_03.png)


## The Complete Unit Circle
> `X-axis` in the image is `Cosine-Axis`, and `Y-axis` is `Sine-Axis`.
![image](20180402152203_Unit-circle_files/img_04.png)

## Exact values of the unit circle
![image](20180402152203_Unit-circle_files/img_05.png)
