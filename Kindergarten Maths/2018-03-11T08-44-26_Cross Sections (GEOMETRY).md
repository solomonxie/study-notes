...
![image](2018-03-11T08-44-26_Cross Sections (GEOMETRY)_files/img_01.png)

> Slice a `cube` to get a `pentagon`:
![image](2018-03-11T08-44-26_Cross Sections (GEOMETRY)_files/img_02.png)

> Slice a `triangular prism` to get a `pentagon`:
![image](2018-03-11T08-44-26_Cross Sections (GEOMETRY)_files/img_03.png)

> Slice a `right pyramid` to get a `pentagon`:
![image](2018-03-11T08-44-26_Cross Sections (GEOMETRY)_files/img_04.png)

> Slice a `cone` to get `Ellipse`:
![image](2018-03-11T08-44-26_Cross Sections (GEOMETRY)_files/img_05.png)

> Slice a `cone` to get a `parabola`:
![image](2018-03-11T08-44-26_Cross Sections (GEOMETRY)_files/img_06.png)
