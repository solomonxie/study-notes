...
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_01.png)
...
### EXAMPLE 
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_02.png)
Solve:
- Set equation `Y(t) = −80`
...
### EXAMPLE
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_03.png)
Solve:
...
### EXAMPLE
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_04.png)
Solve:
- Set equation to `I(t)=5.2`
- Simplify equation to:
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_05.png)
- Get `θ ≃ 0.9273 Rad`
- Get First solution:
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_06.png)
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_07.png)
- Use the trig identity for second solution: `cos(θ) = cos(2π−θ)`.
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_08.png)
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_09.png)
...
Solve:
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_10.png)
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_11.png)
![image](2018-03-19T13-54-32_`Inverse functions`_files/img_12.png)
