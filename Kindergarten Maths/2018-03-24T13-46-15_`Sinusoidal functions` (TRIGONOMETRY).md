...
![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_01.png)

Every period of `sine wave` is a whole unit circle:

![400px-complexsininatimeaxe](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_02.gif)
...
![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_03.png)


## `Midline, amplitude and period` 
> They're three features of `sinusoidal graphs`.

![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_04.png)
...
![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_05.png)
...
`Full period` is `2π`, `Midline` at `y=0`, `Range` is `[1,-1]`.
![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_06.png)
...
Example:
![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_07.png)
...
![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_08.png)
...
Example 2:
![image](2018-03-24T13-46-15_`Sinusoidal functions` (TRIGONOMETRY)_files/img_09.png)
Solve:
- Midline: `y=2.5`
- Amplitude: `|6-2.5|=3.5`
