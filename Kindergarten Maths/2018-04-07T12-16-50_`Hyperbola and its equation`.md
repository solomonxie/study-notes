...
![image](2018-04-07T12-16-50_`Hyperbola and its equation`_files/img_01.png)

`Hyperbola` can be defined as a `curve` where the `distances of any point` from:
- A point (the focus)
- A (the directrix) are always in the same ratio.

![image](2018-04-07T12-16-50_`Hyperbola and its equation`_files/img_02.png)


## `Equation of Hyperbola`

> Equation of hyperbola opens on the **`X-axis`**:
![image](2018-04-07T12-16-50_`Hyperbola and its equation`_files/img_03.png)

> Equation of hyperbola opens on the **`Y-axis`**:
![image](2018-04-07T12-16-50_`Hyperbola and its equation`_files/img_04.png)
...
|D₁ + D₂| = CONSTANT
```
![image](2018-04-07T12-16-50_`Hyperbola and its equation`_files/img_05.png)
...
![image](2018-04-07T12-16-50_`Hyperbola and its equation`_files/img_06.png)


### Example
![image](2018-04-07T12-16-50_`Hyperbola and its equation`_files/img_07.png)
Solve:
