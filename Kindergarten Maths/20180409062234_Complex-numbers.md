# Complex numbers
![image](20180409062234_Complex-numbers_files/img_01.png)
...
![image](20180409062234_Complex-numbers_files/img_02.png)
...
### `Complex Plane`
![image](20180409062234_Complex-numbers_files/img_03.png)

### `Conjugates`
> Its mainly usage is for the complex number's `division`.

![image](20180409062234_Complex-numbers_files/img_04.png)

![image](20180409062234_Complex-numbers_files/img_05.png)
...
![image](20180409062234_Complex-numbers_files/img_06.png)
...
![image](20180409062234_Complex-numbers_files/img_07.png)
...
![image](20180409062234_Complex-numbers_files/img_08.png)
- `Multiplication`:
![image](20180409062234_Complex-numbers_files/img_09.png)
- `Division`: 
Need to use the notion `conjugates`
![image](20180409062234_Complex-numbers_files/img_10.png)
- `Powers`:
Better to convert it to `Exponential form` first, and do powers.
![image](20180409062234_Complex-numbers_files/img_11.png)
...
![image](20180409062234_Complex-numbers_files/img_12.png)
...
![image](20180409062234_Complex-numbers_files/img_13.png)
...
![image](20180409062234_Complex-numbers_files/img_14.png)

For some exact values, we also need the `tangent values of unit circle`:
![image](20180409062234_Complex-numbers_files/img_15.png)



## `Convert between Exponential form & Polar form`
![image](20180409062234_Complex-numbers_files/img_16.png)
...
### Example
![image](20180409062234_Complex-numbers_files/img_17.png)
Solve:
![image](20180409062234_Complex-numbers_files/img_18.png)
![image](20180409062234_Complex-numbers_files/img_19.png)
![image](20180409062234_Complex-numbers_files/img_20.png)
