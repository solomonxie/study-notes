...
![image](2018-02-24T10-17-27_Vim报错`Sorry, this command is disabled, the Python's site mod_files/img_01.png)

通过这个命令，`vim --version | grep python`，我们先查看下当前vim版本对python的支持：
![image](2018-02-24T10-17-27_Vim报错`Sorry, this command is disabled, the Python's site mod_files/img_02.png)
说明我当前的vim支持python，不支持python3.
另外，直接`vim --version`可以先看到，我的vim已经用`brew install vim`更新到了vim 8.0:

![image](2018-02-24T10-17-27_Vim报错`Sorry, this command is disabled, the Python's site mod_files/img_03.png)
...
![image](2018-02-24T10-17-27_Vim报错`Sorry, this command is disabled, the Python's site mod_files/img_04.png)
