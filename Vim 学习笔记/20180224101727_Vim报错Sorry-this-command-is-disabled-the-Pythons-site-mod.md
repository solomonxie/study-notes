...
![image](20180224101727_Vim报错Sorry-this-command-is-disabled-the-Pythons-site-mod_img_01.png)

通过这个命令，`vim --version | grep python`，我们先查看下当前vim版本对python的支持：
![image](20180224101727_Vim报错Sorry-this-command-is-disabled-the-Pythons-site-mod_img_02.png)
说明我当前的vim支持python，不支持python3.
另外，直接`vim --version`可以先看到，我的vim已经用`brew install vim`更新到了vim 8.0:

![image](20180224101727_Vim报错Sorry-this-command-is-disabled-the-Pythons-site-mod_img_03.png)
...
![image](20180224101727_Vim报错Sorry-this-command-is-disabled-the-Pythons-site-mod_img_04.png)
