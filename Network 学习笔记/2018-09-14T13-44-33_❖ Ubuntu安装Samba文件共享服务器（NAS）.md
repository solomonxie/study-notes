...
![image](2018-09-14T13-44-33_❖ Ubuntu安装Samba文件共享服务器（NAS）_files/img_01.png)
...
![image](2018-09-14T13-44-33_❖ Ubuntu安装Samba文件共享服务器（NAS）_files/img_02.png)


然后可以看到，目录中和本地目录几乎没什么区别：能看预览，支持所有文件夹正常的快捷键，随意拷贝粘贴，这是FTP远不能比的。

![image](2018-09-14T13-44-33_❖ Ubuntu安装Samba文件共享服务器（NAS）_files/img_03.png)
...
$ testparm
```
![image](2018-09-14T13-44-33_❖ Ubuntu安装Samba文件共享服务器（NAS）_files/img_04.png)
...
$ sudo pdbedit -L
```
![image](2018-09-14T13-44-33_❖ Ubuntu安装Samba文件共享服务器（NAS）_files/img_05.png)
