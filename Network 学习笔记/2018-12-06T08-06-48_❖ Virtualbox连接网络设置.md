...
![image](2018-12-06T08-06-48_❖ Virtualbox连接网络设置_files/img_01.png)

设置DHCP（这样虚拟机就能有静态IP了）：
![image](2018-12-06T08-06-48_❖ Virtualbox连接网络设置_files/img_02.png)
...
NAT适配器采用默认设置：
![image](2018-12-06T08-06-48_❖ Virtualbox连接网络设置_files/img_03.png)

Host-only设置：
![image](2018-12-06T08-06-48_❖ Virtualbox连接网络设置_files/img_04.png)


然后进入虚拟机（Linux）后，就可以通过`ifconfig`看到本机的内网IP了。

![image](2018-12-06T08-06-48_❖ Virtualbox连接网络设置_files/img_05.png)
...
![image](2018-12-06T08-06-48_❖ Virtualbox连接网络设置_files/img_06.png)


进入虚拟机后，输入命令`ifconfig`就会发现，虚拟机具有了和我的主机在Wifi里同样网段的IP地址（我的wifi网段是`192.168.199.xxx`）：

![image](2018-12-06T08-06-48_❖ Virtualbox连接网络设置_files/img_07.png)
