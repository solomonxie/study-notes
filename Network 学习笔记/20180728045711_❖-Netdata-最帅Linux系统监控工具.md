...
![image](20180728045711_❖-Netdata-最帅Linux系统监控工具_img_01.png)


安装好后，就可以直接打开浏览器：`localhost:19999`看到超酷的画面了（网页很长，显示超多数据）。

![image](20180728045711_❖-Netdata-最帅Linux系统监控工具_img_02.png)
...
![xnip2019-02-19_17-15-31](20180728045711_❖-Netdata-最帅Linux系统监控工具_img_03.png)

这个是从Netdata的Dashboard从查看的应用CPU占用：

![xnip2019-02-19_17-31-41](20180728045711_❖-Netdata-最帅Linux系统监控工具_img_04.png)


这个是从Netdata的Dashboard从查看的应用内存占用：

![xnip2019-02-19_17-33-18](20180728045711_❖-Netdata-最帅Linux系统监控工具_img_05.png)

这个是从Netdata的Dashboard从查看的应用进程占用：

![image](20180728045711_❖-Netdata-最帅Linux系统监控工具_img_06.png)
