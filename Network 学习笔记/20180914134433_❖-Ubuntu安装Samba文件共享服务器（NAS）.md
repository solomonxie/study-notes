...
![image](20180914134433_❖-Ubuntu安装Samba文件共享服务器（NAS）_img_01.png)
...
![image](20180914134433_❖-Ubuntu安装Samba文件共享服务器（NAS）_img_02.png)


然后可以看到，目录中和本地目录几乎没什么区别：能看预览，支持所有文件夹正常的快捷键，随意拷贝粘贴，这是FTP远不能比的。

![image](20180914134433_❖-Ubuntu安装Samba文件共享服务器（NAS）_img_03.png)
...
$ testparm
```
![image](20180914134433_❖-Ubuntu安装Samba文件共享服务器（NAS）_img_04.png)
...
$ sudo pdbedit -L
```
![image](20180914134433_❖-Ubuntu安装Samba文件共享服务器（NAS）_img_05.png)
