...
![image](2019-01-21T12-19-45_Types of learning (ML) - Note on Andrew Ng's course_files/img_01.png)
￼

## Example of `Clustering Algorithm`
`Google News page`, it recognises all similar news and gather to a story board.

![image](2019-01-21T12-19-45_Types of learning (ML) - Note on Andrew Ng's course_files/img_02.png)
