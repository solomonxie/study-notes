...
![image](2018-06-09T17-07-52_❖ Windows安装SSH服务器_files/img_01.png)
- 切换到Windows account选项卡，取消真实windows用户账户
![image](2018-06-09T17-07-52_❖ Windows安装SSH服务器_files/img_02.png)
- 切换到Virtual account虚拟账户选项卡，建立虚拟登录用户账户
![image](2018-06-09T17-07-52_❖ Windows安装SSH服务器_files/img_03.png)
- 输入用户名，或者导入PublicKey公钥。方法是把你自己客户端电脑上的`~/.ssh/id_rsa.pub`文件复制到这个服务器上，然后点击import导入，成为这个虚拟账户的publickey。这样就可以免密码登录了。
![image](2018-06-09T17-07-52_❖ Windows安装SSH服务器_files/img_04.png)
![image](2018-06-09T17-07-52_❖ Windows安装SSH服务器_files/img_05.png)
![image](2018-06-09T17-07-52_❖ Windows安装SSH服务器_files/img_06.png)
![image](2018-06-09T17-07-52_❖ Windows安装SSH服务器_files/img_07.png)
- 回到主界面，Start开启服务
