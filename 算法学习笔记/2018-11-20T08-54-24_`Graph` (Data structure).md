...
![image](2018-11-20T08-54-24_`Graph` (Data structure)_files/img_01.png)
...
![image](2018-11-20T08-54-24_`Graph` (Data structure)_files/img_02.png)
- an `Adjacency Matrix`: a grid of numbers, where each row or column represents a different node in the graph.
![image](2018-11-20T08-54-24_`Graph` (Data structure)_files/img_03.png)
...
![image](2018-11-20T08-54-24_`Graph` (Data structure)_files/img_04.png)
