...
List的定义、结构、操作方法：
![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_01.png)
...
![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_02.png)


## 顺序存储结构 (顺序表 Sequential List / Array List) 

![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_03.png)

![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_04.png)

![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_05.png)

![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_06.png)


## 链式存储结构的线性表 （单链表 Singly Linked List）

![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_07.png)

每个node节点包括两部分信息：
- Data 数据：自身包含的数据
- Pointer 指针：下一个node节点的位置

![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_08.png)

头指针与头节点：
![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_09.png)
...
![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_10.png)
...
![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_11.png)
...
![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_12.png)

Python内置Dictionary字典的操作时间复杂度：
![image](2018-11-08T10-08-12_数组 List (线性表)_files/img_13.png)
