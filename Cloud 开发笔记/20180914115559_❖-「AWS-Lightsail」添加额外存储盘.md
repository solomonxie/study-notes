...
![animated-gif-attach-disk-to-linux-wordpress-instance](20180914115559_❖-「AWS-Lightsail」添加额外存储盘_files/img_01.gif)
...
```
![image](20180914115559_❖-「AWS-Lightsail」添加额外存储盘_files/img_02.png)

如果要确认一下是否格好了，再次输入`sudo file -s /dev/xvdf`即可。这时就会显示：
![image](20180914115559_❖-「AWS-Lightsail」添加额外存储盘_files/img_03.png)
