...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_01.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_02.png)


![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_03.png)

## Method 2: Multiply 「matrix by COLUMN」

Each **column** of the `product matrix C`, is `Matrix A * Column of B`.

![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_04.png)

## Method 3: Multiply 「ROW by matrix」

Each **row** of the `product matrix C`, is `Row of A * Matrix B`.

![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_05.png)


## Method 4: Multiply 「COLUMN by ROW」

![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_06.png)

### 「Dot product」

![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_07.png)

![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_08.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_09.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_10.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_11.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_12.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_13.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_14.png)

Why could we use Gauss-Jordan Elimination to solve `Inverse of matrix`?

![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_15.png)
...
![image](20180503032300_MIT-OCW-18.06-SC-Unit-1.3-Multiplication-Inverse-Matrices_img_16.png)
