...
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_01.png)


### Example
Suppose the goal is to find the solution for the linear system below:
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_02.png)

First we need to turn it into `Augmented Matrix` form:
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_03.png)

Then we apply `Elementary Row Operations`, and result in `Row Echelon Form`:
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_04.png)

At the end, if we'd like, we can further on apply some row operations to get the matrix in `Reduced Row Echelon Form`:
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_05.png)
...
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_06.png)
...
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_11.png)
...
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_12.png)
...
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_13.png)
...
![image](2018-04-20T08-14-03_Matrices Elimination_files/img_14.png)
