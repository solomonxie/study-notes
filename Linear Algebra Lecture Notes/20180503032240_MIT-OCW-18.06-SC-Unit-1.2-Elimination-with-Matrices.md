...
![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_01.png)
...
![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_02.png)
...
![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_03.png)
...
![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_04.png)

Combining **all elimination steps** in ONE MATRIX:
![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_05.png)
...
![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_06.png)

Example: To **switch two COLUMNS of a matrix** by using a `permutation matrix`:
![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_07.png)

### Some common 「permutation matrices」

![image](20180503032240_MIT-OCW-18.06-SC-Unit-1.2-Elimination-with-Matrices_img_08.png)
