...
![image](20190108134006_ZSH安装超酷的powerlevel9k主题_files/img_01.png)
...
![image](20190108134006_ZSH安装超酷的powerlevel9k主题_files/img_02.png)

可以找它建议的，直接在`~/.zshrc`中强制指定终端色彩来解决：
```vim
export TERM="xterm-256color"
```
![image](20190108134006_ZSH安装超酷的powerlevel9k主题_files/img_03.png)
...
```
![image](20190108134006_ZSH安装超酷的powerlevel9k主题_files/img_04.png)
...
![image](20190108134006_ZSH安装超酷的powerlevel9k主题_files/img_05.png)
