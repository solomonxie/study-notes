...
![rec](20190216091352_❖-终端录屏程序asciinema_files/img_01.gif)
...
![image](20190216091352_❖-终端录屏程序asciinema_files/img_02.png)

转换过程很慢，但是文件非常小，远比自己直接录屏要小很多。
比如下面的GIF，直接视频录屏转GIF的文件是7M左右，通过减少帧率和显示效果文件在1M左右，而用asciinema转换为GIF超清晰原画，只有237Kb。可见一斑。


![rec](20190216091352_❖-终端录屏程序asciinema_files/img_03.gif)

![rec](20190216091352_❖-终端录屏程序asciinema_files/img_04.gif)
