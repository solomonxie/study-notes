...
![image](2018-08-15T09-39-48_❖ Probabilities from 「Density Curves」_files/img_01.png)


### Example
![image](2018-08-15T09-39-48_❖ Probabilities from 「Density Curves」_files/img_02.png)
Solve:
...
![image](2018-08-15T09-39-48_❖ Probabilities from 「Density Curves」_files/img_03.png)


### Example
![image](2018-08-15T09-39-48_❖ Probabilities from 「Density Curves」_files/img_04.png)
Solve:
- We know the Probability Distribution is a **Normal Distribution**.
- For the probability of `X<1`, we're to get the **area** of `X<1`.
![image](2018-08-15T09-39-48_❖ Probabilities from 「Density Curves」_files/img_05.png)
