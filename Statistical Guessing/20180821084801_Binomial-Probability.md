...
![image](20180821084801_Binomial-Probability_files/img_01.png)


![image](20180821084801_Binomial-Probability_files/img_02.png)
...
![image](20180821084801_Binomial-Probability_files/img_03.png)

Or use the [`▶︎ Online Combination Calculator`](https://www.omnicalculator.com/statistics/combination).


Example:
![image](20180821084801_Binomial-Probability_files/img_04.png)

### Example
![image](20180821084801_Binomial-Probability_files/img_05.png)
Solve:
- Apply the `Binomial Probability Formula`, the answer is:
![image](20180821084801_Binomial-Probability_files/img_06.png)


## 「Mean & Variance」 of Binomial R.V.

![Formula](20180821084801_Binomial-Probability_files/img_07.png)
...
### Example
![image](20180821084801_Binomial-Probability_files/img_08.png)
Solve:
![image](20180821084801_Binomial-Probability_files/img_09.png)


### Example
![image](20180821084801_Binomial-Probability_files/img_10.png)
Solve:
...
### Example
![image](20180821084801_Binomial-Probability_files/img_11.png)
Solve:
- One way:
![image](20180821084801_Binomial-Probability_files/img_12.png)
- Another way:
![image](20180821084801_Binomial-Probability_files/img_13.png)


### Example
![image](20180821084801_Binomial-Probability_files/img_14.png)
Solve:
- We can see it as `P(X > 3) = P(4) + P(5)`, or `P(X>3) = 1 - (P(1) + P(2) + P(3))`, we're gonna use first one in this case.
![image](20180821084801_Binomial-Probability_files/img_15.png)
