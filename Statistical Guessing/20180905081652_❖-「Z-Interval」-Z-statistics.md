...
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_01.png)
...
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_02.png)

in which the _margin of error_ is:

![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_03.png)


### Example
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_04.png)
Solve:
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_05.png)


### Example
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_06.png)
Solve:
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_07.png)

## 「Sample Size」 & 「Margin of Error」

### Example
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_08.png)
Solve:
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_09.png)


### Example
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_10.png)
Solve:
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_11.png)
...
### Example
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_12.png)
Solve:
...
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_13.png)
...
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_14.png)
- We take the derivative of `p(1-p)` and set to 0, to get the max value: `p = 0.5`
- Calculate the rest:
![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_15.png)


## 「Z-table」

![image](20180905081652_❖-「Z-Interval」-Z-statistics_img_16.png)
