...
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_01.png)

In General:
To multiply an `m×n matrix` by an `n×p matrix`, the `n`s must be the same, 
and the **RESULT** is an `m×p matrix`.
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_02.png)

### Example: 「3x2 Matrix」 with 「2x2 Matrix」
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_03.png)
Solve:
...
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_04.png)
- We get the answer:
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_05.png)

### Example: 2x2 Matrix with 2x3 Matrix
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_06.png)
Solve:
- It's will get a 2x3 new Matrix (just for intuition), then we get the answer:
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_07.png)
...
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_08.png)

[`▶ Use the tool: Desmos Matrix Calculator`](https://www.desmos.com/matrix)

### Example: Transform Graphs
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_09.png)
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_10.png)
Solve:
- Just to list all points of this graph:
`(-4,8), (-8,-4), (-4,-4), (0,4)`
- Arrange points to a Matrix:
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_11.png)
- Apply the Matrix R to the Graph's matrix. Do the math.


### 「Reflection」 of Shapes

![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_12.png)
![image](2018-04-20T14-42-32_❖ Matrix Transformation_files/img_13.png)
