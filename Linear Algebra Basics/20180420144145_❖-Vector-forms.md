...
![image](20180420144145_❖-Vector-forms_img_01.png)
...
- `Row form`: v = (1, 1, -1)
- `Column form`: 
![image](20180420144145_❖-Vector-forms_img_02.png)
...
![image](20180420144145_❖-Vector-forms_img_03.png)
...
![image](20180420144145_❖-Vector-forms_img_04.png)
Which means, it could lie on axis or in between.

![image](20180420144145_❖-Vector-forms_img_05.png)
...
![image](20180420144145_❖-Vector-forms_img_06.png)

![image](20180420144145_❖-Vector-forms_img_07.png)

### How to find a vector's 「unit vector」

> More intuitively to solve it just to draw it out and solve it with trigonometry. 

![image](20180420144145_❖-Vector-forms_img_08.png)

Example: Find the unit vector of vector (-8, 5)
![image](20180420144145_❖-Vector-forms_img_09.png)
