...
### Example
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_01.png)
Solve:
- First, we really really need to graph this out before anything else:
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_02.png)
...
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_03.png)


### Example
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_04.png)
Solve:
- First need to graph it as below (you can get help with Desmos or GeoGebra):
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_05.png)
- Then we know the radius of the semi circle is `x`, so:
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_06.png)


## Volumes of 「unknown solids」

### Example
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_07.png)
Solve:
- Each slice will be like this:
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_08.png)
- The area of the slice would be:
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_09.png)
- The boundaries are at two curves' intersection, which are `x = 1 and 5`
- So integrate all the slices:
![image](2018-06-20T12-57-27_❖ Volumes of 「3D Solids」 (Integral Calc)_files/img_10.png)
