...
![image](20180604074523_Definite-Integrals_files/img_01.png)


## 「Definite integral」 ←→ 「Limit of Riemann Sum」

### Example
![image](20180604074523_Definite-Integrals_files/img_02.png)
Solve:
- It's easy to find `Δx = (π-0)/n = π/n`
- And `x𝖎 = S(𝖎) = a + 𝖎·Δx = 0+𝖎·Δx = 𝖎·π/n`
- So the result is:
![image](20180604074523_Definite-Integrals_files/img_03.png)

### Example
![image](20180604074523_Definite-Integrals_files/img_04.png)
Solve:
...
![image](20180604074523_Definite-Integrals_files/img_05.png)


### Example
![image](20180604074523_Definite-Integrals_files/img_06.png)
Solve:
...
![image](20180604074523_Definite-Integrals_files/img_07.png)

### Example
![image](20180604074523_Definite-Integrals_files/img_08.png)
Solve:
- See the `i=1` means it's using `Right Riemann Sum`, so the integral would be:
![image](20180604074523_Definite-Integrals_files/img_09.png)
...
- So the answer is:
![image](20180604074523_Definite-Integrals_files/img_10.png)
