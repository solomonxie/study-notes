...
![image](20180623122825_Ratio-Test_files/img_01.png)


### Example
![image](20180623122825_Ratio-Test_files/img_02.png)
Solve:
- Apply the `ratio test`:
![image](20180623122825_Ratio-Test_files/img_03.png)
- `L = 0`, so the series absolutely converges.


### Example
![image](20180623122825_Ratio-Test_files/img_04.png)
Solve:
- Apply the `ratio test`, let `a_(n+1) / a_n`.
- The trick is to know: `(n+1)! = (n+1)·n!`, and `(n+8)! = (n+8)·(n+7)!`
- Take the limit to get: 
![image](20180623122825_Ratio-Test_files/img_05.png)
