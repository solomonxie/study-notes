...
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_01.png)
...
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_02.png)
...
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_03.png)
- Take derivative of the parametric function.

### Example
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_04.png)
Solve:
- Since it's asking for the `Rate of change of y-coordinate`, so we convert the polar function to `rectangular function`:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_05.png)
- And we take the derivative `dy/dΘ`:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_06.png)
- Plug in the point `Θ=π` and get:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_07.png)
...
### Example
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_08.png)
Solve:
- To find the tangent line, we need to get the slope first, which is `dy/dx`.
- And `dy/dx` would be a `parametric problem`:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_09.png)
- Plug in the Θ value, to evaluate the slope:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_10.png)
- Find the `x & y` value according to the Θ:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_11.png)
- Now we got everything to form the equation for the tangent line:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_12.png)
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_13.png)



### Example
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_14.png)
Solve:
- First, we need to convert the polar function to `x(θ) & y(θ)`:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_15.png)
- And we need to find the slope `dy/dx`:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_16.png)
...
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_17.png)
- So the answer is:
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_18.png)



### Example
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_19.png)
Solve:
...
![image](20180612093131_「Polar-Curve」-Functions-Differential-Calc_files/img_20.png)
....
