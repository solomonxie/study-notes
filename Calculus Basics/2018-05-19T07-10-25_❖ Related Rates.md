...
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_01.png)
...
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_02.png)
...
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_03.png)
Solve:
...
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_04.png)
- Take back all the known values into the equation get `V'(t)=-2400π`

## `Example: Change of area`
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_05.png)
Solve:
- Write out all conditions algebraically:
    - `d₁'(t) = -7`
    - `d₁(t) = 4`
...
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_06.png)
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_07.png)
...
![image](2018-05-19T07-10-25_❖ Related Rates_files/img_08.png)

## Example: 「multiple composite」

![image](2018-05-19T07-10-25_❖ Related Rates_files/img_09.png)
Solve:
- Write down all the conditions algebraically:
    - `S'(t) = π/2`
    - `S(t) = 12π`
