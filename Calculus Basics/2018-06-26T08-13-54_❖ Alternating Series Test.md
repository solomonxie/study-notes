...
![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_01.png)


## The Alternating Series Test

![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_02.png)

The very good example of this test is the `Alternating Harmonic Series`:

![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_03.png)

▲ It does **CONVERGES**. (But the Harmonic Series does NOT converge)

Strategy:
- Take AWAY the `Alternating sign (-1)ⁿ`:
![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_04.png)
- Determine if the rest part is a decreasing series:
![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_05.png)
- Take limit of the rest part:
![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_06.png)
...
### Example
![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_07.png)
Solve:
...
### Example
![image](2018-06-26T08-13-54_❖ Alternating Series Test_files/img_08.png)
Solve:
- Notice this is an `alternating series`, so we're to apply the `alternating series test`.
