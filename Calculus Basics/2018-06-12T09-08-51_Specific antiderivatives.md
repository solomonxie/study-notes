...
### Example
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_01.png)
Solve:
...
### Example
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_02.png)
Solve:
...
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_03.png)
Solve:
- It looks confusing, but let's assume `f(x)` as `y` so `dy/dx = 2y`
- Separate differential equations to get `dy/y = 2dx`
- Take integral of both sides: 
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_04.png)
- Since `f(1) = 5`, so:
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_05.png)
- And `f(3) = 5e⁴`, which means `m = 5, n = 4`



### Example
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_06.png)
Solve:
Hint: `f(0) = 2`

### Example
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_07.png)
Solve
Hint: Don't need to solve `y` completely.
![image](2018-06-12T09-08-51_Specific antiderivatives_files/img_08.png)
