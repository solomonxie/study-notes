...
Approximation:
![image](20180613080849_Eulers-Method_img_01.png)

Iterate table:
![image](20180613080849_Eulers-Method_img_02.png)


### Example
![image](20180613080849_Eulers-Method_img_03.png)
Solve:
- It need quite a few ticks. But let's see the result first:
![image](20180613080849_Eulers-Method_img_04.png)
