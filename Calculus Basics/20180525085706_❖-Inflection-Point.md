...
![image](20180525085706_❖-Inflection-Point_img_01.png)
...
![image](20180525085706_❖-Inflection-Point_img_02.png)


### Example
![image](20180525085706_❖-Inflection-Point_img_03.png)
...
### Example
![image](20180525085706_❖-Inflection-Point_img_04.png)
Solve:
- Looking for the `parts of concavity shapes`
- There's no changing of concavity shapes, there's only one shape: Concave down.

### Example
![image](20180525085706_❖-Inflection-Point_img_05.png)
Solve:
...
### Example
![image](20180525085706_❖-Inflection-Point_img_06.png)
Solve:
...
![image](20180525085706_❖-Inflection-Point_img_07.png)
Solve:
...
![image](20180525085706_❖-Inflection-Point_img_08.png)
- So it didn't change the concavity at point `-3`, means there's no inflection point for function.

### Example: Finding Inflection points
![image](20180525085706_❖-Inflection-Point_img_09.png)
Solve:
- Function has **POSSIBLE** inflection points when `f''(x) = 0`.
...
- We now know the possible point, but don't know its **CONCAVITY**. This need to try some numbers from its both sides:
![image](20180525085706_❖-Inflection-Point_img_10.png)
