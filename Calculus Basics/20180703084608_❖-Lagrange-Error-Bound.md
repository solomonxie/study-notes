...
![image](20180703084608_❖-Lagrange-Error-Bound_img_01.png)
...
![image](20180703084608_❖-Lagrange-Error-Bound_img_02.png)
(▲ for `C` is the centre of approximation)
- where the max value of **all derivatives** of the function is:
![image](20180703084608_❖-Lagrange-Error-Bound_img_03.png)
...
![image](20180703084608_❖-Lagrange-Error-Bound_img_04.png)



### Example
![image](20180703084608_❖-Lagrange-Error-Bound_img_05.png)
Solve:
...
![image](20180703084608_❖-Lagrange-Error-Bound_img_06.png)
- In this case, it is:
![image](20180703084608_❖-Lagrange-Error-Bound_img_07.png)
...
![image](20180703084608_❖-Lagrange-Error-Bound_img_08.png)
...
![image](20180703084608_❖-Lagrange-Error-Bound_img_09.png)
- Unfortunately, at this moment we don't have easier method to solve for `n` except trying some numbers in:
![image](20180703084608_❖-Lagrange-Error-Bound_img_10.png)
...
### Example
![image](20180703084608_❖-Lagrange-Error-Bound_img_11.png)
Solve:
...
![image](20180703084608_❖-Lagrange-Error-Bound_img_12.png)
- So boundary is `M = 1`.
- Therefore, the formula of this theorem becomes:
![image](20180703084608_❖-Lagrange-Error-Bound_img_13.png)
- In this case, we need to try some numbers for `n` to get the desired value:
![image](20180703084608_❖-Lagrange-Error-Bound_img_14.png)
...
### Example
![image](20180703084608_❖-Lagrange-Error-Bound_img_15.png)
Solve:
- Same with the problem above, we want to apply the `Lagrange Error Bound Theorem`, and bound it to `0.001`:
![image](20180703084608_❖-Lagrange-Error-Bound_img_08.png)
- For those **unknowns** variables in the theorem, we know that:
