...
![image](2018-06-29T09-43-42_❖ Power Series_files/img_01.png)

For easier to remember it, that could be simplified as:

![image](2018-06-29T09-43-42_❖ Power Series_files/img_02.png)
...
![image](2018-06-29T09-43-42_❖ Power Series_files/img_03.png)
...
![image](2018-06-29T09-43-42_❖ Power Series_files/img_04.png)
...
### Example
![image](2018-06-29T09-43-42_❖ Power Series_files/img_05.png)
Solve:
- Let's organize this function to make it clear:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_06.png)



### Example
![image](2018-06-29T09-43-42_❖ Power Series_files/img_07.png)
Solve:
...
![image](2018-06-29T09-43-42_❖ Power Series_files/img_08.png)
- And the **constant number `a_n`** in the function is:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_09.png)
- Let's plug in the real number (0,1,2,3,4) for `n` to expand the series:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_10.png)
- Based on that we can take the derivatives:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_11.png)
- Now we've got the `third derivative`, so let's plug in the `x=0` and see what we get:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_12.png)
...
### Example
![image](2018-06-29T09-43-42_❖ Power Series_files/img_13.png)
Solve:
- Knowing that `Integrate a series` can be turned to `a series of Integrations of terms`:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_14.png)
- Integrate the terms:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_15.png)
- And we get a simple `Geometric series`. So that we can apply the formula of calculating geometric series:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_16.png)
- Let's apply the formula:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_17.png)
...
### Example
![image](2018-06-29T09-43-42_❖ Power Series_files/img_18.png)
Solve:
...
![image](2018-06-29T09-43-42_❖ Power Series_files/img_19.png)
- We see that the `antiderivative` can represent the `g(x)`, but only with the `C` in it:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_20.png)
- So we need to solve for `C`. The easiest way is to plug in `0` for `g(x)`:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_21.png)
- Then the answer is:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_22.png)



### Example
![image](2018-06-29T09-43-42_❖ Power Series_files/img_23.png)
Solve:
- Set the two series as `f(x)` and `g(x)`.
- It's clear that `g(x) = -f'(x)`.
- So by differentiate `f(x)` we will get:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_24.png)
- Then `-f'(x)` would be:
![image](2018-06-29T09-43-42_❖ Power Series_files/img_25.png)
