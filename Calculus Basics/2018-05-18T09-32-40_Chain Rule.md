...
![image](2018-05-18T09-32-40_Chain Rule_files/img_01.png)
...
![image](2018-05-18T09-32-40_Chain Rule_files/img_04.png)
...
### Examples
![image](2018-05-18T09-32-40_Chain Rule_files/img_05.png)
It's a composite function, which the inner is `cos(x)` and outer is `x²`.

![image](2018-05-18T09-32-40_Chain Rule_files/img_06.png)
It's a composite function, which the inner is `2x³-4x` and outer is `sin(x)`.

![image](2018-05-18T09-32-40_Chain Rule_files/img_07.png)
It's a composite function, which the inner is `cos(x)` and outer is `√(x)`.

## Two forms of 「Chain Rule」

The general form of Chain Rule is like this:
![image](2018-05-18T09-32-40_Chain Rule_files/img_08.png)

But the Chain Rule has another **more commonly used** form:
![image](2018-05-18T09-32-40_Chain Rule_files/img_09.png)
...
### Example
![image](2018-05-18T09-32-40_Chain Rule_files/img_10.png)
Solve:
...
Formula:
![image](2018-05-18T09-32-40_Chain Rule_files/img_11.png)

Because:
![image](2018-05-18T09-32-40_Chain Rule_files/img_12.png)


### Example
![image](2018-05-18T09-32-40_Chain Rule_files/img_13.png)
Solve:
- Apply the `Log power rule` to simplify the exponential function:
![image](2018-05-18T09-32-40_Chain Rule_files/img_14.png)
- Differentiate both sides:
![image](2018-05-18T09-32-40_Chain Rule_files/img_15.png)
