...
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_01.png)

### Example
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_02.png)
...
### Example
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_03.png)
...
### Example
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_04.png)
Solve:
...
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_05.png)
...
### Example
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_06.png)
Solve:
...
### Example
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_07.png)
Solve:
- The tricky here is that: `a𝓃 = S𝓃 - S𝓃-1`, because `S𝓃 = a₁ + a₂ + a₃ +.... + a𝓃-1 + a𝓃`.
- So the result is:
![image](20180623060823_❖-「Series」-basics-Calculus-level_files/img_08.png)
