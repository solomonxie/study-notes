...
![image](20180702083757_❖-Taylor-Series_img_01.png)


![image](20180702083757_❖-Taylor-Series_img_02.png)
...
![image](20180702083757_❖-Taylor-Series_img_03.png)
...
![image](20180702083757_❖-Taylor-Series_img_04.png)
...
![97f5384c9b8d6ceebf3b894efc106adb](20180702083757_❖-Taylor-Series_img_05.gif)



### Example
![image](20180702083757_❖-Taylor-Series_img_06.png)
Solve:
- First to know the formula of `Taylor Series` centred at `x=1`:
![image](20180702083757_❖-Taylor-Series_img_07.png)
- The problem is asking the coefficient of `(x-1)³`, means **all the rest part** in the formula, which is:
![image](20180702083757_❖-Taylor-Series_img_08.png)
- And it also means the `n=3`, so the coefficient becomes:
![image](20180702083757_❖-Taylor-Series_img_09.png)
- Let's evaluate the `f'''(1)`:
![image](20180702083757_❖-Taylor-Series_img_10.png)
- So the coefficient is:
![image](20180702083757_❖-Taylor-Series_img_11.png)



### Example
![image](20180702083757_❖-Taylor-Series_img_12.png)
Solve:
- Let's express the Taylor polynomial to the `nth degree` as:
![image](20180702083757_❖-Taylor-Series_img_13.png)
- Since it's asking for the series to the `3rd degree`, then it becomes:
![image](20180702083757_❖-Taylor-Series_img_14.png)
- And we only need to find out every degree of derivatives, and we will get:
![image](20180702083757_❖-Taylor-Series_img_15.png)
- So the Taylor polynomial then is:
![image](20180702083757_❖-Taylor-Series_img_16.png)
