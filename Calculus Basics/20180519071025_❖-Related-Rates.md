...
![image](20180519071025_❖-Related-Rates_img_01.png)
...
![image](20180519071025_❖-Related-Rates_img_02.png)
...
![image](20180519071025_❖-Related-Rates_img_03.png)
Solve:
...
![image](20180519071025_❖-Related-Rates_img_04.png)
- Take back all the known values into the equation get `V'(t)=-2400π`

## `Example: Change of area`
![image](20180519071025_❖-Related-Rates_img_05.png)
Solve:
- Write out all conditions algebraically:
    - `d₁'(t) = -7`
    - `d₁(t) = 4`
...
![image](20180519071025_❖-Related-Rates_img_06.png)
![image](20180519071025_❖-Related-Rates_img_07.png)
...
![image](20180519071025_❖-Related-Rates_img_08.png)

## Example: 「multiple composite」

![image](20180519071025_❖-Related-Rates_img_09.png)
Solve:
- Write down all the conditions algebraically:
    - `S'(t) = π/2`
    - `S(t) = 12π`
