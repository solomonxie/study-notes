...
![image](2018-05-23T10-31-41_❖ Critical points_files/img_01.png)
...
### Example
![image](2018-05-23T10-31-41_❖ Critical points_files/img_02.png)
Solve:
- See that original function `f(x)` is undefined at `x = 2 or -2`
- Differentiate `f(x)` to get `f'(x)`:
![image](2018-05-23T10-31-41_❖ Critical points_files/img_03.png)
- Solve `f'(x)=0` only when `x=0`.
- `f'(x)` is undefined when `x=2 or -2`, as the same with `f(x)` so it's not a solution.


### Example
![image](2018-05-23T10-31-41_❖ Critical points_files/img_04.png)
...
- Differentiate `f(x)` to get `f'(x)`:
![image](2018-05-23T10-31-41_❖ Critical points_files/img_05.png)
