...
### Example
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_01.png)
Solve:
- We can identify there's a `Integral trig rule` we can apply on this problem:
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_02.png)
- Therefore we're gonna organize it a bit with `u-substitution` and get the answer:
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_03.png)


### Example
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_04.png)
Solve:
...
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_05.png)
- And also we need to change the boundaries for the integral:
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_06.png)
- Now we can start to integrate:
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_07.png)


### Example
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_08.png)
Solve:
- We're gonna use a `trig-integral-rule` and a `trig identity`:
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_09.png)
- Then apply them:
![image](2018-06-07T10-18-57_Integration using 「Trig identities」_files/img_10.png)
