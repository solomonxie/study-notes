...
### Example
![image](2018-05-31T10-15-56_Planar motion (Derivative of vectors)_files/img_01.png)
Solve:
...
### Example
![image](2018-05-31T10-15-56_Planar motion (Derivative of vectors)_files/img_02.png)
Solve:
- `P(t) = (2t²-6t, -t³+10t)`
- `v(t) = P'(t) = (4t-6, -3t²+10)`
- `v(2) = (2, -2)`
...
![image](2018-05-31T10-15-56_Planar motion (Derivative of vectors)_files/img_03.png)
...
### Example
![image](2018-05-31T10-15-56_Planar motion (Derivative of vectors)_files/img_04.png)
Solve:
- `P(t) = (x, y)`
- `x' = 1/2`
- `v(t) = P'(t) = (x', y') = (1/2, y')`
