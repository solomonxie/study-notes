...
![image](20180620095532_Arc-Length-Integral-Calc_files/img_01.png)
![image](20180620095532_Arc-Length-Integral-Calc_files/img_02.png)

## Formula
![image](20180620095532_Arc-Length-Integral-Calc_files/img_03.png)

### Example
![image](20180620095532_Arc-Length-Integral-Calc_files/img_04.png)
Solve:
- `f'(x) = 1/x`
- According to the formula:
![image](20180620095532_Arc-Length-Integral-Calc_files/img_05.png)
...
![image](20180620095532_Arc-Length-Integral-Calc_files/img_06.png)

Formula:

![image](20180620095532_Arc-Length-Integral-Calc_files/img_07.png)


### Example of finding out the right boundaries
Find out the boundaries for each shape:
![image](20180620095532_Arc-Length-Integral-Calc_files/img_08.png)
Solve:
- Compute the intersections:
![image](20180620095532_Arc-Length-Integral-Calc_files/img_09.png)
- So thinking of how we draw the arc: starts from `π/3`, through origin (0), ??
![image](20180620095532_Arc-Length-Integral-Calc_files/img_10.png)
- The chord (straight line) starts at `-π/3` and ends at `π/3`.


### Example
Find out the right boundaries for θ for the red arc length:
![image](20180620095532_Arc-Length-Integral-Calc_files/img_11.png)
Solve:
...
- We set `r=0` and get:
![image](20180620095532_Arc-Length-Integral-Calc_files/img_12.png)
- From the graph we could see it clearly, the red arc starts at `θ=π/6`
- So the boundaries are `0, π/6`


### Example
![image](20180620095532_Arc-Length-Integral-Calc_files/img_13.png)
Solve:
...
![image](20180620095532_Arc-Length-Integral-Calc_files/img_14.png)
- Now apply the arc length formula on the interval:
![image](20180620095532_Arc-Length-Integral-Calc_files/img_15.png)
