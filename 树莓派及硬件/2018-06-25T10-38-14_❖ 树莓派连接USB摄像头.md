...
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_01.png)
- 安装`motion`程序：
```sh
...
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_02.png)
- 打开`motion`程序的配置文件：
```sh
$ sudo vim /etc/motion/motion.conf
```
- 把`daemon off`改成`daemon on`:
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_03.png)
- 确认视频流的接口是`8081`：
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_04.png)
- 把`stream_localhost on`改成`stream_localhost off`，关闭localhost本地的限制：
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_05.png)
- 把`sdl_threadnr`注释屏蔽掉：
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_06.png)
- 保存文件，退出。
- 开启`motion`程序的daemon，`sudo motion`:
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_07.png)
- 打开浏览器查看树莓派的摄像头影像，地址是：`http://树莓派IP地址:8081`:

然后会看到浏览器一直在刷新显示这个小图像（分辨率不高）▼：

![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_08.png)
...
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_09.png)
...
![image](2018-06-25T10-38-14_❖ 树莓派连接USB摄像头_files/img_10.png)
