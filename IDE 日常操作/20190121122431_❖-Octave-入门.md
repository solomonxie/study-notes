...
![image](20190121122431_❖-Octave-入门_img_01.png)
可以看到，octave需要非常多的依赖包。我装了大概一个多小时吧。完成后，就可以通过命令行输入`octave`直接进入了：
![image](20190121122431_❖-Octave-入门_img_02.png)
...
![image](20190121122431_❖-Octave-入门_img_03.png)
...
![screencast 2018-02-25 01-03-33](20190121122431_❖-Octave-入门_img_04.gif)
