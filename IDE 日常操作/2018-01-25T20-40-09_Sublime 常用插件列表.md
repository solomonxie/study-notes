...
![sublime-text-3-the-git](2018-01-25T20-40-09_Sublime 常用插件列表_files/img_01.gif)
...
![11-codeintel](2018-01-25T20-40-09_Sublime 常用插件列表_files/img_02.gif)
- **Minify** 将各种代码压缩并生成`.min`文件，包括js，python等多种
- **Placeholders** 为HTML快速生成"伪图片"
![9-placeholder](2018-01-25T20-40-09_Sublime 常用插件列表_files/img_03.gif)
- **TernJS** 自动补全变量、属性等。
![image](2018-01-25T20-40-09_Sublime 常用插件列表_files/img_04.png)
