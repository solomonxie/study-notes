...
```
然后来测试下变量cc：
![image](20180208062146_❖-Python2操作JSON出现乱码的解决方案_img_01.png)
...
![image](20180208062146_❖-Python2操作JSON出现乱码的解决方案_img_02.png)
...
但是这里问题出现了！我们来小试一下：
![image](20180208062146_❖-Python2操作JSON出现乱码的解决方案_img_03.png)
...
下面是个小测试：
![image](20180208062146_❖-Python2操作JSON出现乱码的解决方案_img_04.png)
...
```
来看结果：
![image](20180208062146_❖-Python2操作JSON出现乱码的解决方案_img_05.png)
