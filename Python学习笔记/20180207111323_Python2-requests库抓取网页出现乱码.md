...
![image](20180207111323_Python2-requests库抓取网页出现乱码_files/img_01.png)
...
![image](20180207111323_Python2-requests库抓取网页出现乱码_files/img_02.png)
虽然这句话不是为了处理网页的，但是`二进制`！沿着这个思路，又在官网看怎么将网页获取为二进制模式的：
![image](20180207111323_Python2-requests库抓取网页出现乱码_files/img_03.png)
就是使用`r.content`获取。
