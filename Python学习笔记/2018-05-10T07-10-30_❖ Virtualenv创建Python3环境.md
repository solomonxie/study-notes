...
```
然后很快就安装成果，并显示如下：
![image](2018-05-10T07-10-30_❖ Virtualenv创建Python3环境_files/img_01.png)

这个时候在命令行里输入`python`，就会直接跳入python3的编程环境了。
![image](2018-05-10T07-10-30_❖ Virtualenv创建Python3环境_files/img_02.png)

然后我们通过`which`命令，得知两种版本python的位置，便于之后virtualenv的设置：
![image](2018-05-10T07-10-30_❖ Virtualenv创建Python3环境_files/img_03.png)
...
![image](2018-05-10T07-10-30_❖ Virtualenv创建Python3环境_files/img_04.png)
错误原文如下：
```shell
