...
![rec](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_01.gif)

但是这个最简单的Server有一个致命缺点——同一时间只能接收一个client客户，如果有另一个客户，就会排队等待，直到前一个客户退出连接。展示效果如下：

![rec](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_02.gif)
...
![rec](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_03.gif)
...
![rec2](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_04.gif)
...
![rec](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_05.gif)
...
![image](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_06.png)
...
![image](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_07.png)
...
```
![image](20181114094016_❖-动图长文-一个案例了解Python多进程、多线程、协程、高并发处理：自己实现一个最简单的Web-Server_img_08.png)
