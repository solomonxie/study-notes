...
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_01.png)
...
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_02.png)
...
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_03.png)
(图片引用自知乎相关某答案。)

来回记住这个问题，才能进入下一步！

然后来看个案例。
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_04.png)

> 通过上面两种格式的对比我们看到，str和unicode的各种区别。

那么，既然变量里面会出现两种不同的格式，如果我们把两种格式的字符串连在一起操作会发生什么呢？
如下：
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_05.png)
...
### 然后我们来读取一下：
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_06.png)

> 上面看到，从文件读取出来的，就是str格式的字符串。
那么如果要把str转化为unicode，就要解码，也就是decoding.

![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_07.png)
...
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_08.png)
...
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_09.png)
...
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_10.png)
...
![image](20180207163531_❖-关于解决Python2乱码问题的终极解决方案-TL-DR_files/img_11.png)
