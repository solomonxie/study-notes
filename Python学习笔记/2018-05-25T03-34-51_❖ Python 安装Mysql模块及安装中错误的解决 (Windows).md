...
![image](2018-05-25T03-34-51_❖ Python 安装Mysql模块及安装中错误的解决 (Windows)_files/img_01.png)
打开页面，http://www.lfd.uci.edu/~gohlke/pythonlibs/ 是这个模样：
![image](2018-05-25T03-34-51_❖ Python 安装Mysql模块及安装中错误的解决 (Windows)_files/img_02.png)
