...
```
然后来测试下变量cc：
![image](2018-02-08T06-21-46_❖ Python2操作JSON出现乱码的解决方案_files/img_01.png)
...
![image](2018-02-08T06-21-46_❖ Python2操作JSON出现乱码的解决方案_files/img_02.png)
...
但是这里问题出现了！我们来小试一下：
![image](2018-02-08T06-21-46_❖ Python2操作JSON出现乱码的解决方案_files/img_03.png)
...
下面是个小测试：
![image](2018-02-08T06-21-46_❖ Python2操作JSON出现乱码的解决方案_files/img_04.png)
...
```
来看结果：
![image](2018-02-08T06-21-46_❖ Python2操作JSON出现乱码的解决方案_files/img_05.png)
